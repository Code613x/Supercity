...
echo.
echo.
if %iloscjarmark% GEQ 100 echo [1] 100 Houses Advancment - Unlocked
if not %iloscjarmark% GEQ 100 echo [1] 100 Houses Advancment - Locked
echo.
if %iloscwiezowiec% GEQ 100 echo [2] 100 Skyscrapers Advancment - Unlocked
if not %iloscwiezowiec% GEQ 100 echo [2] 100 Skyscrapers Advancment - Locked
echo.
if %iloscaltana% GEQ 100 echo [3] 100 Bowers Advancment - Unlocked
if not %iloscaltana% GEQ 100 echo [3] 100 Bowers Advancment - Locked
echo.
if %iloscapartament% GEQ 100 echo [4] 100 Apartaments Advancment Unlocked
if not %iloscapartament% GEQ 100 echo [4] 100 Apartaments Advancment - Locked
echo.
if %iloscjarmark% GEQ 100 echo [5] 100 Fairs Advancment Unlocked
if not %iloscjarmark% GEQ 100 echo [5] 100 Fairs Advancment - Locked
echo.
if %iloscdom% GEQ 1000 echo [6] 1000 Houses Advancment Unlocked
if not %iloscdom% GEQ 1000 echo [6] 1000 Houses Advancment - Locked
echo.
if %iloscwiezowiec% GEQ 1000 echo [7] 1000 Skyscrapers Advancment Unlocked
if not %iloscwiezowiec% GEQ 1000 echo [7] 1000 Skyscrapers Advancment - Locked
echo.
if %iloscaltana% GEQ 1000 echo [8] 1000 Bowers advancment unlocked
if not %iloscaltana% GEQ 1000 echo [8] 1000 Bowers Advancment - Locked
echo.
if %iloscapartament% GEQ 1000 echo [9] 1000 Apartaments Advancment Unlocked
if not %iloscapartament% GEQ 1000 echo [9] 1000 Apartaments Advancment - Locked
echo.
if %iloscjarmark% GEQ 1000 echo [10] 1000 Fairs Advancment Unlocked
if not %iloscjarmark% GEQ 1000 echo [10] 1000 Fairs Advancment - Locked
pause >nul
goto front
