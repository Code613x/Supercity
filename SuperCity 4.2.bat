...
echo Update: UI and Text Update
...
echo.
echo Game Creators:
echo - Code613 (Polish Youtuber)
echo - EMOJI TV YT (Polish Streamer)
echo.
echo.
echo Game Version - 4.2
echo Update: UI and Text Update
echo.
...
echo.
echo What's New?
echo -A Bit More Better UI (User Interface)
echo -Better Text Dispaly
echo -New Pre-Menu Option: Update Info
echo -New Advancments (x2)
echo -Bonus code has been changed
pause >nul
cls 
goto 0
...
if /i %mieszkancy% GEQ /i 100000 if /i %mieszkancy% LEQ 100200 if /i %nagrody% LSS 3 goto winner3
...
echo # 9. Advancments                       #
echo # 10. Save Game                        #
echo # 11. Change Text Color                #
echo #==============#  Stats  #=============#
echo # 12. Player Stats                     #
echo # 13. City Stats                       #
echo ########################################
echo.
...
if %cho%==8 goto buyfood
if %deadcity%==1 if %cho%==CDB goto hirecs
if %deadcity%==1 if %cho%==Cdb goto hirecs
if %deadcity%==1 if %cho%==cdb goto hirecs
if %cho%==9 goto advancments0
if %cho%==10 goto save
if %cho%==11 goto changecolor2
if %cho%==12 goto pstats
if %cho%==13 goto cstats
